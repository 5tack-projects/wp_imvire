<?php 
    ...
    get_template_part('partials/pageblocks/cases');
    get_template_part('partials/pageblocks/content');
    // get_template_part('partials/pageblocks/services');
    get_template_part('partials/pageblocks/projects');
    get_template_part('partials/pageblocks/references');
